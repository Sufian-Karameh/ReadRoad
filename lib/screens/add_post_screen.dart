...
class _AddPostScreenState extends State<AddPostScreen> {
      ...
      body: SingleChildScrollView(
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Center(child: getPageWidgets()),
          ),
        ),
      ),
    );
  ...
  bool isEmpty() {
    return review.text.isEmpty || selected1 == false || rate == -1;
  }
    ...
    await db.collection("Books").get().then(
      (querySnapshot) {
        for (var docSnapshot in querySnapshot.docs) {
          docList.add(
              {"BookName": docSnapshot!.id!, "BookData": docSnapshot!.data()});
          //i++;
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return ListTile(
                    ...
                    title: DropdownButton(
                        ...
                        hint: Text("Pick the Book to Review"),
                  ...
                  title: DropdownButton(
                    ...
                    onChanged: (val) {
                      setState(() {
                        ...
                        selectedBook = doc["book"] = map["BookName"] as String;
                        doc["bookNum"] = map["BookData"]["image"];
                        doc["author"] = map["BookData"]["author"];
                        doc["genre"] = map["BookData"]["genre"];
                      });
                    },
                    value: selectedBook,
                    hint: Text("Pick the Book to Review"),
        ...
        ElevatedButton(
            onPressed: isEmpty()
                ...
                : () async {
                    ...
                    doc["username"] = FirebaseAuth
                        .instance.currentUser?.displayName as Object;
                    var data = await db
                        .collection("Users")
